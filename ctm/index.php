	...
	<div class="col-right">
		<div class="col-right-container">
			...
			<div class="ctm-info">
				...
				<p>А так же, производство флакона <b>любой формы</b></p>

				<p><b>AllGreen все сделает за ВАС!</b></p>

				<p>Вы создаете - AllGreen производит!</p>

				<p title="Воспользуйтесь формой заявки в верхней части сайта">Оставьте заявку и наш специалист свяжется с вами в ближайшее время!</p>
