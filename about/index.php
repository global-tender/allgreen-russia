	...
	<div class="col-right">
		<div class="col-right-container">
			...
			<div class="about-company-text">
				<p>
					«Алл Грин» - производитель высококачественных моющих средств. Специализация предприятия направлена на производство товаров бытовой химии, косметических средств. Продукты компании находят широкое применение в быту, клининговых компаниях, различных отраслях промышленности, общественных и производственных помещениях, ресторанах, кафе и гостиницах.
				</p>
				<p></p>
				<p>
					Преимущества использования моющих средств «Алл Грин»:
					<ul>
						<li>возможность использования на поверхностях, выполненных из любых материалов, без риска их повреждения;</li>
						<li>моющие средства могут использоваться без дополнительных средств защиты, не представляя угрозы здоровью человека;</li>
						<li>концентрация позволяет достигать желаемого результата при применении минимального количества средства;</li>
						<li>продукция «Алл Грин» биологически разлагаема в условиях окружающей среды;</li>
						<li>высокое качество сочетается с приемлемыми ценами.</li>
					</ul>
				</p>
				<br />
				...
				<p>
					Мы располагаем:
					<ul>
						<li>Производственными мощностями, оснащенными современным и высокопроизводительным оборудованием;</li>
						<li>Типографией, позволяющей производить любые виды и тиражи этикеток;</li>
						<li>Производством ПЭТ тары объемом от 0,2 л. до 5,0 л.;</li>
						<li>Складским комплексом, рассчитанным на обеспечение бесперебойной работы предприятия.</li>
					</ul>
				</p>
				<p>
			...
			<div class="about-company-text">
				...
				<p>Приезжайте и взгляните на производство своими глазами!</p>
				...
				<p>10 лет продукция AllGreen отвечает высочайшему европейскому качеству!</p>
